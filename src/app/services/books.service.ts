...
//  metodo en pages/book ***
  ...
  public getOneApi() {
    return this.http.get(`${this.url}/booksByQuery?id`)
  }

  public deleteApi(book: Books) {
    return this.http.delete(`${this.url}/booksByQuery?id=${book.id_book}`)
  }
...
// metodo en pages/updateBook ***
  public updateApi(book: Books) {
    return this.http.put(`${this.url}/booksByQuery?id=${book.id_book}`, book)
  }
